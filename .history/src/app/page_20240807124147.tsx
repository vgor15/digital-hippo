...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description:
      "Every assets on out platform is verified by our team to ensure out highest quality standards. Not happy? We offer a 30-day refund guarantee.",
  },
  {
      ...
      <section className="border-t border-gray-200 bg-gray-50">
        <MaxWidthWrapper className="py-20">
          <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-0">
            {perks.map((perk) => (
              <div key={perk.name} className="text-center md:flex md:items-start md:text-left lg:block lg:texc">
