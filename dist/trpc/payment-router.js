...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        var user, productIds, payload, products, productsArray, product, filteredProducts, order, line_items, stripeSession, err_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    filteredProducts = productsArray.filter(function (prod) {
